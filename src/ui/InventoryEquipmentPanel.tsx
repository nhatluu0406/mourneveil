...
export function InventoryEquipmentPanel({ snapshot, runtime, open, onClose }: InventoryEquipmentPanelProps) {
  const { inventory, equipment, resolvedAttackDamage, playerHealth, defense, progression } = snapshot
  if (!open) return null
  ...
  return (
    <div className="inventory-overlay" role="presentation">
      <aside className="inventory-panel inventory-panel--build" aria-label="Inventory, equipment, and progression">
        ...
        <section className="inventory-owned">
