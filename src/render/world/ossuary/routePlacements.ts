...
const LATE_ROUTE_PRACTICALS: readonly WorldObjectPlacement[] = Object.freeze([
  ...
  place('sconce.corridor.0', 'ossuary.light.wall-sconce', 'corridor', [-8.35, 1.28, 3.8], [0, Math.PI, 0]),
  ...
  place('brazier.court', 'ossuary.light.ember-bowl', 'mixed-court', [1.1, 1.05, -6.4], ZERO_ROTATION, [1.18, 1.18, 1.18], 'actual-light'),
  ...
  place('double-sconce.court.west', 'ossuary.light.double-sconce', 'mixed-court', [-2.72, 1.35, -5.35], [0, Math.PI / 2, 0], [0.92, 0.92, 0.92]),
...
const MIXED_COURT_SHELL: readonly WorldObjectPlacement[] = Object.freeze([
  ...
  place('split-buttress.court.south', 'ossuary.buttress.split', 'mixed-court', [2.65, 1.02, -1.3], [0, -Math.PI / 2, 0], [0.92, 0.92, 0.92]),
  place('niche-cluster.court.west.0', 'ossuary.niche.cluster', 'mixed-court', [-2.97, 1.05, -5.55], [0, Math.PI / 2, 0], [1, 1, 1]),
  place('niche-cluster.court.west.1', 'ossuary.niche.cluster', 'mixed-court', [-2.97, 1.05, -2.9], [0, Math.PI / 2, 0], [0.92, 0.92, 0.92]),
  place('memorial-cluster.court.north', 'ossuary.memorial.cluster', 'mixed-court', [1.95, 0.4, -6.72], [0, 0.12, 0], [1.1, 1.1, 1.1]),
  place('memorial-cluster.court.south', 'ossuary.memorial.cluster', 'mixed-court', [0.35, 0.4, -1.32], [0, -0.18, 0], [0.92, 0.92, 0.92]),
  ...[-6.35, -5.9, -2.25].map((z, index) => place(`chain.court.${index}`, 'ossuary.reliquary.chain', 'mixed-court', [3.72, 1.85, z], [0, Math.PI / 2, index * 0.5], [1, 1.35 + index * 0.12, 1])),
